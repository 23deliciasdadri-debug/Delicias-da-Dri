...
/**
 * Página de login unificada para clientes e funcionários.
 * Suporta login com email/senha e Google OAuth.
 */
const LoginPage: React.FC = () => {
    const navigate = useNavigate();
    const { session, profile, signIn, isLoading: authLoading } = useAuth();
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                // O redirect é feito pelo useEffect acima
            }
        } catch (err) {
